...
class XMLReport(object):
    ...
    _exception_code_names_per_platform_type = {
    ...
    class Exception(XMLReportEntity):
        ...
        @property
        def name(self):
            if self._owner.platform_type in XMLReport._exception_code_names_per_platform_type:
                code_to_name_map = XMLReport._exception_code_names_per_platform_type[self._owner.platform_type]
